...
public class Server {
    ...
    public void privateMsg(String nick, String msg, ClientHandler fromNick){
        for(ClientHandler o : clients){
            if(o.getNick().equals(nick)){
                o.sendMsg("from "+ fromNick+ ": "+ msg);
                fromNick.sendMsg("to " + nick + ": "+ msg);
                return;
            }
        }
        fromNick.sendMsg(nick + "offline");
    }
}
